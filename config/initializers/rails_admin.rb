# RailsAdmin config file. Generated on January 28, 2013 17:34
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Chargify Test', 'Admin']
  ...
  # config.excluded_models = ['Product', 'ProductFamily', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Product', 'ProductFamily', 'Role', 'User']
  ...
  # config.model 'ProductFamily' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your product_family.rb model definition
